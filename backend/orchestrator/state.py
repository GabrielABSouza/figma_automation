...
class ScreenHTML(BaseModel):
    """Raw HTML generated by the HTML Generator agent for one screen."""

    screen_name: str
    html: str


class FigmaTreeScreen(BaseModel):
    """Figma node tree for one screen, ready for plugin rendering."""
...
class PipelineState(BaseModel):
    ...
    screen_htmls: list[ScreenHTML] = Field(default_factory=list)
    figma_trees: list[FigmaTreeScreen] = Field(default_factory=list)
    errors: list[str] = Field(default_factory=list)
